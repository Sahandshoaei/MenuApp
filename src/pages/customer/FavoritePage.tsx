...
const FavoritePage = () => {
  ...
  if (favorites.length === 0) {
    return (
      <Container className="flex min-h-[60vh] flex-col items-center justify-center px-6 pb-28">
        <div
        ...
        >
          روی آیکون قلب هر آیتم بزنید تا اینجا ذخیره شود.
        </p>
      </Container>
    );
  }
  ...
  return (
    <Container className="space-y-6 px-4 pb-28 pt-6">
      <div
      ...
      >
        <div className="text-right">
          ...
          <p
            ...
            style={{ color: "var(--color-text-secondary)" }}
          >
            {favorites.length} مورد ذخیره‌شده
          </p>
        </div>
